# Kod Drzewa Decyzyjnego
# Autorzy: Dominik Pióro i Nicol Pawełczak

# Import bibliotek służących do Machine learningu(AI)
import numpy as np
import pandas as pd

# Import danych
col_names = ["Temperatura", "Wiatr", "Pogoda", "Grać w Badmintona"]
data = pd.read_csv("seattle-weather.csv", skiprows=1, header=None, names=col_names)
line_numbers = 10
data.head(line_numbers)

# Tworzymy strukture węzła
...
class DecisionTreeClassifier:
    def __init__(self, min_samples_split=2, max_depth=2):
        # inicjowanie korzenia (czyli pierwszy węzeł)
        self.root = None
